...
He subido cambios nuevos a la rama main. Por favor actualicen sus repositorios locales:

1. git checkout main
2. git pull origin main

Si están trabajando en sus ramas, también pueden actualizarlas con:
git checkout Leandro Maquetado 
git merge main
